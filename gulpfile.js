var fs = require("file-system"),
    ...
    //agencytheme = require('./src/Wd3eCore.Themes/TheAgencyTheme/wwwroot/gulpfile'),
    //blogtheme = require('./src/Wd3eCore.Themes/TheBlogTheme/wwwroot/gulpfile');
...
//    var cwd = process.cwd();
//    process.chdir('./src/Wd3eCore.Themes/TheAgencyTheme/wwwroot');
//    agencytheme.build(() => {
//        process.chdir(cwd);
//        done();
//    });
...
//    var cwd = process.cwd();
//    process.chdir('./src/Wd3eCore.Themes/TheBlogTheme/wwwroot');
//    blogtheme.build(() => {
//        process.chdir(cwd);
//        done();
//    });
...
function getAssetGroups() {
    var assetManifestPaths = glob.sync("./src/Wd3eCore.{Modules,Themes}/*/Assets.json", {});
    var assetGroups = [];
...
function resolveAssetGroupPaths(assetGroup, assetManifestPath) {
    ...
    //assetGroup.webroot = path.join("./src/Wd3eCore.Cms.Web/wwwroot/", path.basename(assetGroup.basePath), path.dirname(assetGroup.output));
}
