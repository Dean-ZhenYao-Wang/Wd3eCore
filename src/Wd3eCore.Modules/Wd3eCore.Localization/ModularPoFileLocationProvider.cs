...
namespace Wd3eCore.Localization
{
    ...
    public class ModularPoFileLocationProvider : ILocalizationFileLocationProvider
    {
        ...
        public IEnumerable<IFileInfo> GetLocations(string cultureName)
        {
            ...
            // Load each modules .po file for extending localization when using Wd3e Core as a Nuget package
            foreach (var extension in extensions)
            {
                // \src\Wd3eCore.Cms.Web\Localization\Wd3eCore.Cms.Web\fr-CA.po
            ...
            // e.g, \src\Wd3eCore.Cms.Web\Localization\fr-CA\*.po
