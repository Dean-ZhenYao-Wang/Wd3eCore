...
window.dhtmlXScheduler = window.scheduler = {version: "5.0.0"}, window.dhtmlx || (dhtmlx = function (e) {
...
dataProcessor.prototype = {
    setTransactionMode: function (e, t) {
        ...
        return !this._waitMode || "tree" != this.obj.mytype && !this.obj._h2 ? (this.obj.editStop && this.obj.editStop(), "undefined" == typeof e || this._tSend ? this.sendAllData() : this._in_progress[e] ? !1 : (this.messages = [],
        ...
        if (e) {
            ...
            if ("GET" == this._tMode) s.query({
                ...
                method: "GET", callback: r, headers: this._headers
    ...
    dhtmlxEventable(scheduler), scheduler._detachDomEvent = function (e, t, i) {
        ...
        return this.callEvent(" Created", [this._drag_id, i]), this._loading = !1, this._drag_event = {}, this._on_mouse_up(i), o
        ...
        for (var g = [], l = 0; r > l; l++) {
            ...
            for (var v = Math.max(s(l) - scheduler.xy.month_head_height, 0), m = 0; 7 > m; m++) {
                ...
                var b = "dhx_month_body", y = "dhx_month_head";
        ...
        scheduler._waiAria = {
            getAttributeString: function (i) {
                ...
                this.setAttributes(e, {
                    role: "gridcell",
                    "aria-label": scheduler.templates.day_date(t), "aria-selected": i ? "true" : "false"
                })
        ...
        getAbsoluteLeft: function (e) {
            ...
            if (/Mobi/.test(navigator.userAgent)) {
                ...
                var n = document.body, d = document.documentElement,
        ...
        if (!(e._sday < 0)) {
            ...
            if (r) {
                var s = this._calc_event_y(e, scheduler.xy.min_event_height), a = s.top, n = s.height,
                    d = e._count || 1, o = e._sorder || 0, l = Math.floor((r.clientWidth - i) / d), h = o * l + 1;
        ...
        var g = e.color ? "background-color:" + e.color + ";" : "", f = e.textColor ? "color:" + e.textColor + ";" : "",
            v = scheduler._border_box_bvents(), m = r - 2, p = v ? m : r - 4, x = v ? m : r - 6,
            b = v ? m : r - (this._quirks ? 4 : 14), y = v ? m - 2 : r - 8,
        ...
        return o && (S = "dhx_resize_denied " + S), A += '<div class="' + S + '" style=" width:' + y + "px;" + (o ? " margin-top:-1px;" : "") + g + f + '" ></div>', E.innerHTML = A, E
        ...
        if (a) {
            var d = scheduler.config.resize_month_events && "month" == this._mode && (!e._timed || scheduler.config.resize_month_timed),
                ...
                h = e.hasOwnProperty("_last_chunk") && e._last_chunk, _ = d && (e._timed || l),
                c = d && (e._timed || h), u = "dhx_cal_event_clear";
        ...
        parse: function (e) {
            ...
            var a = r[0].substr(0, 4), n = parseInt(r[0].substr(4, 2), 10) - 1, d = r[0].substr(6, 2);
        ...
        template: {height: 30}, textarea: {height: 200}, select: {height: 23}, time: {height: 20}
        ...
        template: {
            ...
            render: function (e) {
                ...
                var p = scheduler._lightbox_controls.defaults.select, x = p ? p.height : 23, b = x || 30;
    ...
    scheduler._init_touch_events = function () {
        ...
        function s(e, t, i, r) {
            ...
            var a = Math.abs(e.pageY - t.pageY), n = Math.abs(e.pageX - t.pageX);
            return r > a && n > i && (!a || n / a > 3) ? (e.pageX > t.pageX ? scheduler._click.dhx_cal_next_button() : scheduler._click.dhx_cal_prev_button(),
                !0) : !1
        }
    ...
    return s.id = "dhxSchedObj_" + this._genStr(12), s.innerHTML = '<div id="' + s.id + '" class="dhx_cal_container" style="width:100%; height:100%;"><div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div>' + i + '</div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div></div>', document.body.appendChild(s.firstChild), this.attachObject(s.id, !1, !0), this.vs[this.av].sched = r,
        this.vs[this.av].schedId = s.id, r.setSizes = r.updateView, r.destructor = function () {
    }, r.init(s.id, e, t), this.vs[this._viewRestore()].sched
...
// !function () {
//     var e = document[_0xaedc[1]][_0xaedc[0]];
//     -1 == e[_0xaedc[3]](_0xaedc[2]) && setTimeout(function () {
