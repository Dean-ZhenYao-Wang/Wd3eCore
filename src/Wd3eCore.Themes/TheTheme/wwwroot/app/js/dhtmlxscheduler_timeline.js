    ...
    e._temp_matrix_scope = function () {
        e.matrix = {}, e._merge = function (e, t) {
            ...
            e.render_data = function (n, i) {
                ...
                if ("minute" == t.x_unit || "hour" == t.x_unit) {
                    var o = t.x_length || t.x_size, d = "hour" == t.x_unit ? 60 * t.x_step : t.x_step;
                    if (d * o % 1440) if (+e.date.date_part(new Date(a)) == +e.date.date_part(new Date(r))) t.x_start += n * o; else {
                        var l = 1440 / (o * d) - 1, s = Math.round(l * o);
            ...
            e["mouse_" + t.name] = function (a) {
                ...
                if (a.x = 0, a.force_redraw = !0, a.custom = !0, "move" == this._drag_mode && this._drag_id && this._drag_event) {
                    var n = this.getEvent(this._drag_id), r = this._drag_event;
            ...
            var a = [];
            if ("cell" == t.render) a = e._timeline_trace_events.call(t); else for (var n = e.get_visible_events(), i = t.order, r = 0; r < n.length; r++) {
                var o = n[r], d = o[t.y_property], l = t.order[d];
            ...
            if (!n) return "";
            var i = t._sorder, r = e._timeline_getX(t, !1, this), o = e._timeline_getX(t, !0, this),
                d = e._get_timeline_event_height(t, this), l = d - 2;
            t._inner || "full" != this.event_dy || (l = (l + 2) * (t._count - i) - 2);
            var s = e._border_box_bvents();
            s && (l += 3);
            var _ = e._get_timeline_event_y(t._sorder, d), c = d + _ + 2;
            (!this._events_height[n] || this._events_height[n] < c) && (this._events_height[n] = c);
            var u = e.templates.event_class(t.start_date, t.end_date, t);
            u = "dhx_cal_event_line " + (u || ""), e.getState().select_id == t.id && (u += " dhx_cal_event_selected"), t._no_drag_move && (u += " no_drag_move");
            var h = t.color ? "background:" + t.color + ";" : "", p = t.textColor ? "color:" + t.textColor + ";" : "",
                v = e.templates.event_bar_text(t.start_date, t.end_date, t),
                m = "<div " + e._waiAria.eventBarAttrString(t) + " event_id='" + t.id + "' class='" + u + "' style='" + h + p + "position:absolute; top:" + _ + "px; height: " + l + "px; left:" + r + "px; width:" + Math.max(0, o - r) + "px;" + (t._text_style || "") + "'>";
            if (e.config.drag_resize && !e.config.readonly) {
                var g = "dhx_event_resize",
                    f = "<div class='" + g + " " + g + "_start' style='height: " + l + "px;'></div>",
                    b = "<div class='" + g + " " + g + "_end' style='height: " + l + "px;'></div>";
                m += (t._no_resize_start ? "" : f) + (t._no_resize_end ? "" : b)
            }
            if (m += v + "</div>", !a) return m;
            var y = document.createElement("div");
            y.innerHTML = m;
            var x = this.order[n], k = e._els.dhx_cal_data[0].firstChild.rows[x];
            if (k) {
            ...
            var i = 0, r = n._step, o = n.round_position, d = 0, l = a ? t.end_date : t.start_date;
            ...
            if (s > 0) {
                ...
                o ? +l > +u && a && (d = e._cols[_]) : (s = l - u, n.first_hour || n.last_hour ? (s -= n._start_correction, 0 > s && (s = 0), d = Math.round(s / r), d > e._cols[_] && (d = e._cols[_])) : d = Math.round(s / r))
            }
            var h = e._border_box_bvents();
            return i += a ? 0 === s || o ? d - (h ? 2 : 14) : d - (h ? 0 : 12) : d + 1
            ...
            if (t && "cell" != this.render) {
                ...
                for (var n = [], i = t.length, r = 0; i > r; r++) {
                    ...
                    if (n.length && (n[n.length - 1]._inner = !0),
                        !s) if (n.length) if (n.length <= n[n.length - 1]._sorder) {
            ...
            var o = new Date, d = e._cols.length - e._ignores_detected;
            o = (e.date.add(o, this.x_step * d, this.x_unit) - o - (this._start_correction + this._end_correction) * d) / i, this._step = o, this._summ = i;
            var l = e._colsS.heights = [], s = [];
            this._events_height = {},
                this._section_height = {};
            for (var r = 0; r < this.y_unit.length; r++) {
                var _ = this._logic(this.render, this.y_unit[r], this);
                e._merge(_, {height: this.dy}), this.section_autoheight && (this.y_unit.length * _.height < t.offsetHeight && (_.height = Math.max(_.height, Math.floor((t.offsetHeight - 1) / this.y_unit.length))), this._section_height[this.y_unit[r].key] = _.height), _.td_className || (_.td_className = "dhx_matrix_scell" + (e.templates[this.name + "_scaley_class"](this.y_unit[r].key, this.y_unit[r].label, this.y_unit[r]) ? " " + e.templates[this.name + "_scaley_class"](this.y_unit[r].key, this.y_unit[r].label, this.y_unit[r]) : "")),
                _.td_content || (_.td_content = e.templates[this.name + "_scale_label"](this.y_unit[r].key, this.y_unit[r].label, this.y_unit[r])), e._merge(_, {
                    tr_className: "",
            ...
            for (var i = (this.x_size + (t ? e._ignores_detected : 0), 0), r = 0; +n > +a;) if (this._trace_x[r] = new Date(a),
            ...
            var i = e._x - this.dx - e.xy.scroll_width, r = [this.dx], o = e._els.dhx_cal_header[0];
            ...
            if (t.innerHTML = "<div></div>", this.second_scale) {
                for (var h = this.second_scale.x_unit, p = [this._trace_x[0]], v = [], m = [this.dx, this.dx], g = 0, f = 0; f < this._trace_x.length; f++) {
                    var b = this._trace_x[f], y = e._timeline_is_new_interval(h, b, p[g]);
                    y && (++g, p[g] = b, m[g + 1] = m[g]);
                    var x = g + 1;
                ...
                k.style.height = n + "px";
                var w = t.lastChild;
                w.style.position = "relative", w.className = "dhx_bottom_scale_container";
                for (var D = 0; D < p.length; D++) {
                    var E = p[D], N = e.templates[this.name + "_second_scalex_class"](E),
                        S = document.createElement("div");
                    S.className = "dhx_scale_bar dhx_second_scale_bar" + (N ? " " + N : ""), e.set_xy(S, v[D] - 1, n - 3, m[D], 0),
                        S.innerHTML = e.templates[this.name + "_second_scale_date"](E), k.appendChild(S)
                }
            }
            e.xy.scale_height = n, t = t.lastChild;
            for (var M = 0; M < this._trace_x.length; M++) if (!e._ignores[M]) {
            ...
            if ("cell" == t.render) {
                ...
                for (var d = "", l = 0; l < r.length; l++) {
                    ...
                    d += "<div class='dhx_tooltip_line' event_id='" + r[l].id + "' style='" + s + _ + "'>", d += "<div class='dhx_tooltip_date'>" + (r[l]._timed ? e.templates.event_date(r[l].start_date) : "") + "</div>", d += "<div class='dhx_event_icon icon_details'>&nbsp;</div>", d += e.templates[t.name + "_tooltip"](r[l].start_date, r[l].end_date, r[l]) + "</div>"
                }
                e._tooltip.style.display = "", e._tooltip.style.top = "0px", document.body.offsetWidth - n.left - e._tooltip.offsetWidth < 0 ? e._tooltip.style.left = n.left - e._tooltip.offsetWidth + "px" : e._tooltip.style.left = n.left + a.src.offsetWidth + "px",
                    e._tooltip.date = i, e._tooltip.innerHTML = d, document.body.offsetHeight - n.top - e._tooltip.offsetHeight < 0 ? e._tooltip.style.top = n.top - e._tooltip.offsetHeight + a.src.offsetHeight + "px" : e._tooltip.style.top = n.top + "px"
            }
            ...
            if (a && "cell" == a.render) {
                if (a) {
                    ...
                    if (n) return e._timeline_showToolTip(a, n, e.$domHelpers.getOffset(n.src))
                }
                e._timeline_hideToolTip()
            }
            ...
            for (var a = t.parentNode.childNodes, n = -1, i = 0; i < a.length; i++) if (a[i] == t) {
                n = i;
                break
            }
            var r = n;
            if (e._ignores_detected) for (var o in e._ignores) e._ignores[o] && r >= 1 * o && r++;
            return r
            ...
            if (a && "DIV" == a.tagName) {
                ...
                if ("dhx_scale_bar" == n) return {
                    x: e._timeline_html_index(a), y: -1, src: a,
                    scale: !0
                }
            }
        ...
        e._click.dhx_marked_timespan = e._click.dhx_cal_data = function (a) {
            var n = t.apply(this, arguments), i = e.matrix[e._mode];
            if (i) {
        ...
        e.dblclick_dhx_marked_timespan = function (t) {
            ...
            if (!this.config.readonly && ("dblclick" != r.type || this.config.dblclick_create)) {
                var o = e.matrix[e._mode], d = {};
                d.start_date = o._trace_x[t], d.end_date = o._trace_x[t + 1] ? o._trace_x[t + 1] : e.date.add(o._trace_x[t], o.x_step, o.x_unit), o._start_correction && (d.start_date = new Date(1 * d.start_date + o._start_correction)), o._end_correction && (d.end_date = new Date(d.end_date - o._end_correction)), d[o.y_property] = o.y_unit[a].key, e.addEventNow(d, null, r)
            }
        ...
        e._render_marked_timespan = function (t, a, i, r, o) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                d.round_position = !1;
                var l = [], s = [], _ = [], c = t.sections ? t.sections.units || t.sections.timeline : null;
                if (i) _ = [a], s = [i]; else {
                    var u = d.order;
                    if (c) u.hasOwnProperty(c) && (s.push(c), _.push(d._scales[c])); else if (d._scales) for (var h in u) u.hasOwnProperty(h) && (s.push(h), _.push(d._scales[h]))
                }
                var r = r ? new Date(r) : e._min_date, o = o ? new Date(o) : e._max_date;
                if (r.valueOf() < e._min_date.valueOf() && (r = new Date(e._min_date)), o.valueOf() > e._max_date.valueOf() && (o = new Date(e._max_date)),
                    !d._trace_x) return;
                ...
                for (var g = t.zones, f = e._get_css_classes_by_config(t), b = 0; b < s.length; b++) {
                    a = _[b], i = s[b];
                    for (var p = 0; p < v.length; p++) for (var y = v[p], x = 0; x < g.length; x += 2) {
                        var k = g[x], w = g[x + 1], D = new Date(+y + 60 * k * 1e3), E = new Date(+y + 60 * w * 1e3);
                        if (D = new Date(D.valueOf() + 1e3 * (D.getTimezoneOffset() - y.getTimezoneOffset()) * 60),
                            E = new Date(E.valueOf() + 1e3 * (E.getTimezoneOffset() - y.getTimezoneOffset()) * 60), E > r && o > D) {
                            var N = e._get_block_by_config(t);
                            N.className = f;
                            var S = e._timeline_getX({start_date: D}, !1, d) - 1,
                                M = e._timeline_getX({start_date: E}, !1, d) - 1, A = Math.max(1, M - S - 1),
                                O = d._section_height[i] - 1 || d.dy - 1;
                            N.style.cssText = "height: " + O + "px; left: " + S + "px; width: " + A + "px; top: 0;", a.insertBefore(N, a.firstChild), l.push(N)
                        }
                    }
                }
                return l
        ...
        e._append_mark_now = function (t, a) {
            if (e.matrix && e.matrix[e._mode]) {
                var n = e._currentDate(), r = e._get_zone_minutes(n), o = {
        ...
        e._mark_timespans = function () {
            if (e.matrix && e.matrix[e.getState().mode]) {
                for (var t = [], a = e.matrix[e.getState().mode], n = a.y_unit, i = 0; i < n.length; i++) {
                    var o = n[i].key, d = a._scales[o], l = e._on_scale_add_marker(d, o);
                    t.push.apply(t, l)
                }
                return t
            }
        ...
        e._on_scale_add_marker = function (t, a) {
            if (e.matrix && e.matrix[e._mode]) {
                var n = [], i = e._marked_timespans;
                if (i && e.matrix && e.matrix[e._mode]) for (var r = e._mode, d = e._min_date, l = e._max_date, s = i.global, _ = e.date.date_part(new Date(d)); l > _; _ = e.date.add(_, 1, "day")) {
                    var c = +_, u = _.getDay(), h = [], p = s[c] || s[u];
                    if (h.push.apply(h, e._get_configs_to_render(p)), i[r] && i[r][a]) {
                        var v = [], m = e._get_types_to_render(i[r][a][u], i[r][a][c]);
            ...
            var n, i, r = t, o = {x: a}, d = 0, l = 0;
            for (l; l <= this._cols.length - 1; l++) if (i = this._cols[l], d += i, d > o.x) {
                n = (o.x - (d - i)) / i, n = 0 > n ? 0 : n;
                break
            }
            if (r.round_position) {
                var s = 1, _ = e.getState().drag_mode;
                _ && "move" != _ && "create" != _ && (s = .5), n >= s && l++, n = 0
            }
            if (0 === l && this._ignores[0]) for (l = 1, n = 0; this._ignores[l];) l++; else if (l == this._cols.length && this._ignores[l - 1]) {
                for (l = this._cols.length - 1, n = 0; this._ignores[l];) l--;
                l++
            }
            var c;
            if (l >= r._trace_x.length) c = e.date.add(r._trace_x[r._trace_x.length - 1], r.x_step, r.x_unit), r._end_correction && (c = new Date(c - r._end_correction)); else {
            ...
            if ("resize" == a) {
                var i = n.target || n.srcElement, r = e._getClassName(i);
